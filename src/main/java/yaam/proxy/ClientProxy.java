...
public class ClientProxy extends CommonProxy {
	...
	public void registerRenderers() {
		...
		mesher.register(obsidian_paxel, 0, new ModelResourceLocation(
		...
		mesher.register(quartz_paxel, 0, new ModelResourceLocation(
		...
		mesher.register(emerald_axe, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + emerald_axe.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(emerald_shovel, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + emerald_shovel.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(emerald_hoe, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + emerald_hoe.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(emerald_paxel, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + emerald_paxel.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(emerald_helmet, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + emerald_helmet.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(emerald_chestplate, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + emerald_chestplate.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(emerald_leggings, 0, new ModelResourceLocation(
		...
		mesher.register(lapis_chestplate, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + lapis_chestplate.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(lapis_leggings, 0, new ModelResourceLocation(
		...
		mesher.register(iron_paxel, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + iron_paxel.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(gold_paxel, 0, new ModelResourceLocation(
				YAAM.MODID + ":" + gold_paxel.getUnlocalizedName().substring(5), "inventory"));
		mesher.register(diamond_paxel, 0, new ModelResourceLocation(
