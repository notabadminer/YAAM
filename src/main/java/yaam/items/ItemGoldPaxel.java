...
public class ItemGoldPaxel extends ItemPickaxe {
	...
	public ItemGoldPaxel(String unlocalizedName, ToolMaterial material) {
		super(material);
	...
	public boolean getIsRepairable(ItemStack toRepair, ItemStack repair) {
		if (net.minecraftforge.oredict.OreDictionary.itemMatches(new ItemStack(Items.gold_ingot), repair, false))
			return true;
