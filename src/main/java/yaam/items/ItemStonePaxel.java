...
public class ItemStonePaxel extends ItemPickaxe {
	...
	public ItemStonePaxel(String unlocalizedName, ToolMaterial material) {
		super(material);
	...
	public boolean getIsRepairable(ItemStack toRepair, ItemStack repair) {
		if (net.minecraftforge.oredict.OreDictionary.itemMatches(new ItemStack(Blocks.cobblestone), repair, false))
			return true;
