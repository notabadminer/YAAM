...
public class ItemWoodPaxel extends ItemPickaxe {
	...
	public ItemWoodPaxel(String unlocalizedName, ToolMaterial material) {
		super(material);
	...
	public boolean getIsRepairable(ItemStack toRepair, ItemStack repair) {
		if (net.minecraftforge.oredict.OreDictionary.itemMatches(new ItemStack(Blocks.planks), repair, false))
			return true;
